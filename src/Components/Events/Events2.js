...
const Events2 = () => {
  ...
  <div>
     <section id="thumbnail">
        ...
        <Cards title={"Events/Competitions"} por={event_List.EventsCompetitions} btn={true} tilt={false} colm={6} className={'eventcard my-3'}/>
        <Cards title={"informals"} por={event_List.Informals} btn={false} tilt={false} colm={12} className={'eventcard my-3'}/>
        </section>
