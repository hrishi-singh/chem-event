...
const About = (props) => {
  return (
    ...
    <section className='about'>
        ...
        <p>{props.name} is a one-day symposium organized by the Department of Chemical Engineering, IIT Jodhpur. It is an amalgamation of many academic components with 
