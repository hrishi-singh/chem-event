...
const About = (props) => {
  return (
    <div className='about'>
      ...
      <p>
        The Department of Chemical Engineering, IIT Jodhpur is delighted to organize ‘CHEM-E-SORPTION 2023’ with a theme of ‘Sustainable Chemical Engineering’.
        ...
        The core idea of this event is to provide a platform to the young talented engineering students and enthusiastic research scholars with the real
